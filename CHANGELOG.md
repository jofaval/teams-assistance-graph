...
- Darkened main chart axis title labels (including the bottom X-axis footer label) to improve readability and contrast.

### Fixed

- Tooltips for the main chart now display correctly when hovering over the chart area, even when the mouse is not directly over a data point.
